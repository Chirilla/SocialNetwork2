...
for k in [2,6]:
    ...
    for method,fname in zip(
        ...
        'results_K{}_BNC_K.txt','results_K{}_BNC_Kplus1.txt',
...
fnames = ['results_K6_SCG-MA.txt', 'results_K6_SCG-MO.txt', 'results_K6_SCG-B.txt', 'results_K6_SCG-R.txt',
        'results_K6_BNC_K.txt', 'results_K6_BNC_Kplus1.txt',
        'results_K6_SPONGE_K.txt', 'results_K6_SPONGE_Kplus1.txt']
dnames = ['SCG-MA', 'SCG-MO', 'SCG-B', 'SCG-R', 'BNC-k', 'BNC-(k+1)', 'SPONGE-k', 'SPONGE-(k+1)']
for fname,dname in zip(fnames, dnames):
    ...
    for l in data:
        if 'Running' in l:
            ...
            vs = []
    Sizes[dname] = Gs.copy()
DName = {d:x for d,x in zip(datasets,['congress'])}
...
for name in ['GroundTruth','SCG-MA', 'SCG-MO', 'SCG-B', 'SCG-R', 'BNC_K', 'BNC_Kplus1', 'SPONGE_K', 'SPONGE_Kplus1']:
